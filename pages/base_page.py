...
from locators.locators import UniversalLocators

#сюда вынесены общие элементы для всех страниц
class BasePage:
    url = ""  # URL переопределяется классом соответствующей страницы

    pagelocator = None  # уникальный локатор конкретной страницы

    locators = UniversalLocators
    ...
    def wait_page_to_be_open(self):
        ...
        return self.wait_for(self.pagelocator)
